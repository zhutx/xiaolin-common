...
import com.xiaolin.fish.common.crypto.Crypto;
import com.xiaolin.fish.common.crypto.Crypto.Encoding;
...
public abstract class AbstractCryptoImpl implements Crypto {
	...
	protected void removeLocalCiper() {
		CryptoCipher cc = local.get();
		if (cc != null) {
			local.remove();
		}
